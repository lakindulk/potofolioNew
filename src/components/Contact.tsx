                ...
                <div>
                    ...
                    <div className="mt-12 space-y-6">
                        <div className="flex items-center gap-4">
                            ...
                            <span className="text-lg font-medium text-black dark:text-[#F8FAFC]">lakindulk9@gmail.com</span>
                        </div>
                        <div className="flex items-center gap-4">
                            ...
                            <span className="text-lg font-medium text-black dark:text-[#F8FAFC]">+94 71 581 6400</span>
                        </div>
                    </div>
                </div>
                ...
                <form className="bg-white dark:bg-[#1E293B] p-8 md:p-12 rounded-3xl shadow-xl border border-gray-100 dark:border-gray-800 transition-colors">
                    <div className="grid grid-cols-1 gap-6">
                        <div>
                            ...
                            <input type="text" className="w-full bg-gray-50 dark:bg-[#0F172A] border-none rounded-xl px-6 py-4 outline-none focus:ring-2 ring-[#3E7B6C]/20 transition-all font-medium text-black dark:text-[#F8FAFC]" placeholder="Lakindu Kavishka" />
                        </div>
                        <div>

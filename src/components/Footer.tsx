...
const Footer = () => {
    ...
    const socials = [
        { name: 'Github', icon: <Github className="w-5 h-5" />, href: "https://github.com/lakindulk" },
        { name: 'LinkedIn', icon: <Linkedin className="w-5 h-5" />, href: "https://www.linkedin.com/in/lakindu-kavishka-18a07a1b8/" },
    ];
